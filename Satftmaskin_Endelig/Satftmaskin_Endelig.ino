...
/*
 * Disclaimer: Denne koden er ikke 100% ferdigstilt. Det er tydelig kommentert der det er aktuellt.
 */
...
const int pMod1 = 22230; // Tiden det tar i [ms] for pumpe 1 og fylle opp 2 cl væske
const int pMod2 = 28500; // Tiden det tar i [ms] for pumpe 2 og fylle opp 2 cl væske
const int pMod3 = 4730; // Ekstra tid i [ms] for pumpe 1 sin "treghet"
const int pMod4 = 5600; // Ekstra tid i [ms] for pumpe 2 sin "treghet"
...
void juice() {
  ...
  */
  ...
  delay(tP1);
  digitalWrite(pumpPin1, LOW); // Skrur av pumpe 1

  //Venter så lenge som pumpe 2 ytterligere skal stå på (subtraherer tid allerede gått)
  delay(tP2-tP1);
  digitalWrite(pumpPin2, LOW); // Skruv av pumpe 2
